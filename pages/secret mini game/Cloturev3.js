  ...
  if (!spinning) {
    ...
    setTimeout(() => {
      ...
      if (winner === "Cloture") {
        ...
        speakResult("C'est l'heure de la cloture !  Chacun votre tour vous allez parler du déroulement de votre journée.      C'est un moment safe ,     on ne rigole pas,    on n'interrompt pas la parole,    pas de téléphone.       Un tour complet sans que personne ne prenne parole et la cloture est terminée !              Arthur , à toi de commencer !");
