...
const phrases = ["Khalil", "Arthur", "Clara", "Leo", "Lucas", "Neïs", "Clara", "Mame","Maud","Adrien","Remy","Lena","L'encadrant du jour"];
...
function spinWheel() {
  if (!spinning) {
    ...
    setTimeout(() => {
      alert(`${selectedPhrase} va démarer la cloture aujourd'hui`);
