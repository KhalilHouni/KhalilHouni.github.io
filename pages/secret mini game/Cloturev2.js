...
const words = ["Arthur", "Clara", "Sabri", "Lucas", "Mamé-Diara", "Neïs", "Maud", "Encadrant(te) du jour"];
const phoneticNames = ["Arthur", "Clara", "Sabri", "Luka", "Mamé-Diara", "Neïsse","Moode", "Encadrant(te) du jour"];
let lastWinner = null;
